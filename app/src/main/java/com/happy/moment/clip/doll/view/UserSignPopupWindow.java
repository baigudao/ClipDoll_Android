...
public class UserSignPopupWindow extends PopupWindow implements View.OnClickListener {

    private UserSignPopupWindowListener listener;
    ...
    public UserSignPopupWindow(Context context, UserSignPopupWindowListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.user_sign_in_dialog, null));
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                UserSignPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
