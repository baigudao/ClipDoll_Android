...
/**
 * Created by Devin on 2018/2/2 10:04
 * E-mail:971060378@qq.com
 */

public class UserSignSuccessPopupWindow extends PopupWindow implements View.OnClickListener {

    private UserSignSuccessPopupWindowListener listener;
    protected Context context;

    public interface UserSignSuccessPopupWindowListener {

        void onSignClicked();
    }

    public UserSignSuccessPopupWindow(Context context, UserSignSuccessPopupWindowListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.user_sign_in_success_dialog, null));
    ...
    public void initView() {
        getContentView().findViewById(R.id.btn_sign).setOnClickListener(this);
    }
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                UserSignSuccessPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
