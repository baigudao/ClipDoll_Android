...
/**
 * Created by Devin on 2018/2/3 16:45
 * E-mail:971060378@qq.com
 */

public class UserTaskPopupWindow extends PopupWindow implements View.OnClickListener {

    private UserTaskPopupWindowListener listener;
    protected Context context;

    public interface UserTaskPopupWindowListener {

        void onCancelClicked();
    }

    public UserTaskPopupWindow(Context context, UserTaskPopupWindowListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.user_task_dialog, null));
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                UserTaskPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
