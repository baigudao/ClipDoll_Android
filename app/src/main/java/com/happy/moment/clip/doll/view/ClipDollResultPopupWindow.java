...
/**
 * Created by Devin on 2017/12/18 14:18
...
public class ClipDollResultPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void initView() {
        ImageView iv_cancel = (ImageView) getContentView().findViewById(R.id.iv_cancel);
        ...
        //        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) iv_cancel.getLayoutParams();
        //        layoutParams.setMargins(0, 0, 90, 0);
        //        iv_cancel.setLayoutParams(layoutParams);
