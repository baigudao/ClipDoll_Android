...
/**
 * Created by Devin on 2018/2/7 11:05
...
public class TurnTableFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        ((TextView) view.findViewById(R.id.tv_bar_title)).setText("大转盘");
        ...
        try {
            ...
            if (EmptyUtils.isNotEmpty(jsonObject)) {
                ...
                //                user_protocol_url = "http://wwh5.tuuban.com/turntable?userId=" + userId;//测试
                user_protocol_url = "http://h5.52z.cn/turntable?userId=" + userId;//正式
            }
